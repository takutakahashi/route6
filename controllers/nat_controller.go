...
//+kubebuilder:rbac:groups=route6.io,resources=nats,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=route6.io,resources=nats/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=route6.io,resources=nats/finalizers,verbs=update
